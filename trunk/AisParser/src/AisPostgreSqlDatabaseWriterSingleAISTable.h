#ifndef AisPostgreSqlDatabaseWriterSingleAISTable_h
#define AisPostgreSqlDatabaseWriterSingleAISTable_h
...
*/
class AisPostgreSqlDatabaseWriterSingleAISTable : public AisWriter{
public:
	AisPostgreSqlDatabaseWriterSingleAISTable(std::string username, std::string password, std::string hostname, std::string databaseName, std::string tableName, int iterations = 100000):
